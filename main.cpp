...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Gotoken-seeder\n"
...
static const string mainnet_seeds[] = {"gotokens01.freeddns.org", "gotokens02.freeddns.org", "gotokens03.freeddns.org", "seed.prenges.ml", ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 25063), true);
  }
  do {
